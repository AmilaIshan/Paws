...
<nav class="p-2" style="background-color: #FFA500;">
    <div class="flex justify-between items-center">
        <div class="flex items-center space-x-4">
            <span class="mr-24"><img src="{{ asset('images/logo.png') }}" alt="Logo" style="width: 50px; height: auto;"></span>
            <ul class="hidden lg:flex space-x-10 text-black text-lg font-semibold">
        ...
        <div class="flex items-center space-x-4">
            <div class="hidden md:flex relative">
                <input type="text" class="py-1 px-3 h-10 w-96 rounded-md bg-white-700 text-black placeholder-gray-400 focus:outline-none focus:ring focus:border-red-700" placeholder="Search...">
