...
<div class="bg-primary md:w-[400px] lg:w-[700px] h-[700px] lg:h-[700px] p-2 flex flex-col justinfy-content rounded-lg">
        <form action="" method="post" enctype="multipart/form-data">
            @csrf
            <label for="" class="text-lg font-semibold m-4 ">Product Name:</label>
            <input name="product_name" type="text" class=" md:w-[350px] lg:w-[350px] h-[30px] m-2 p-2 rounded-sm">

            <label for="" class="text-lg font-semibold m-4 ">Product Category:</label>
            <select name="category" id="" class="md:w-[350px] lg:w-[350px] h-[30px] m-2 rounded-sm">
            ...
            <input name="sku" type="number" min=1 class=" md:w-[350px] lg:w-[350px] h-[30px] m-2 p-2 rounded-sm">

            <label for="" class="text-lg font-semibold m-4 ">Price:</label>
            <input name="price" type="number"  min=1 class=" md:w-[350px] lg:w-[350px] h-[30px] m-2 p-2 rounded-sm">

            <label for="" class="text-lg font-semibold m-4 ">Discount:</label>
            <input name="discount" type="number"  min=1 class=" md:w-[350px] lg:w-[350px] h-[30px] m-2 p-2 rounded-sm">

            <label for="" class="text-lg font-semibold m-4 ">Description: </label>
            <textarea name="description" class=" md:w-[350px] lg:w-[350px] h-[150px] m-2 p-2 rounded-sm" id=""></textarea>
